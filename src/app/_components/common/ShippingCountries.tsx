...
const ShippingCountries = () => {
  ...
  const countries: Country[] = useMemo(() => ([
    ...
    { name: "Venezuela", code: "ve", link: "/posts/Envios_Internacionales_Trackers_SlimeVR", flag: "🇻🇪", shipping: "ups" },
    { name: "Puerto Rico", code: "pr", link: "/posts/Envios_Internacionales_Trackers_SlimeVR", flag: "🇵🇷", shipping: "ups" },
