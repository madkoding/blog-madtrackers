...
export const translations = {
  ...
  es: {
    ...
    benefit1Desc: "2-3 días de seguimiento con nuestra tecnología RF eficiente",
    benefit2Title: "Precisión Mejorada", 
    benefit2Desc: "Seguimiento con magnetómetro para una precisión superior",
    benefit3Title: "Diseño Ultraliviano",
    benefit3Desc: "Siente la libertad de movimiento",
    benefit4Title: "Materiales Profesionales",
    benefit4Desc: "Construcción en PETG para durabilidad y rendimiento",
    benefit5Title: "Sensores Avanzados",
    benefit5Desc: "Sensor y magnetómetro para tecnología de seguimiento de vanguardia",
