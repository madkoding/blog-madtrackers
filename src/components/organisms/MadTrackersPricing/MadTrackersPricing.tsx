...
const MadTrackersPricing: React.FC<MadTrackersPricingProps> = ({ className = "" }) => {
  const {
    sensors: sensorsT,
    trackers: trackersT,
    colors: colorsT,
...
- Cantidad: ${selectedQuantity}`
  ...
  return (
    <section className={`py-16 px-4 bg-white text-black ${className}`} id="pricing">
      <div className="bg-gray-100 p-4 rounded-lg shadow-lg max-w-2xl mx-auto text-center">
        ...
        <Button
          ...
          className="mx-auto bg-purple-900 text-white font-bold rounded-full mt-4 py-4 px-8 shadow opacity-100 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
          {t.askNow}
        </Button>
...
export default MadTrackersPricing;
